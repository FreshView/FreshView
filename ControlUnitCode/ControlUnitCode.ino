...
//void getDesiredTemp()
// {//char DAT[10];
  float setTempF, AirTempF, FanF; //define float 
 ...
 String FanS = Firebase.getString("/FirebaseIOT/Fan");  //read the fan input from the firebase
// FanS.remove(0,2);
 //Serial.println(FanS); 
 FanF = FanS.toFloat();
 Serial.print("FanF:");
 ...
 delay(100);
  ...
  if( (AirTempF > setTempF) ||  (FanF == 1) ) //set conditions to set the fan HIGH
   {
    Serial.println("Fan HIGH");
    digitalWrite(Fan, HIGH);
    }
   else if( (AirTempF <= setTempF)  || (FanF == 0)) //set conditions to set low
    {
...
//  if( setTempF < AirTempF  ) //set conditions to set the fan HIGH
//   {
//    Serial.println("Fan HIGH");
//    digitalWrite(Fan, HIGH);
//    }
//
//   if(  FanF == 1 ) //set conditions to set the fan HIGH
//   {
//    Serial.println("Fan HIGH");
//    digitalWrite(Fan, HIGH);
//    }
//    
//   if( setTempF > AirTempF  ) //set conditions to set low
//    {
//    Serial.println("Fan LOW");
//    digitalWrite(Fan, LOW);
//   }
...
//   if(  FanF == 0) //set conditions to set low
//    {
//    Serial.println("Fan LOW");
//    digitalWrite(Fan, LOW);
//   }
  ...
  float setMoistureF, MoistureF, PumpF;  //define float
 ...
 String PumpS = Firebase.getString("/FirebaseIOT/Pump");
// PumpS.remove(0,2);
// Serial.println(PumpS);
 PumpF = PumpS.toFloat();
 Serial.print("PumpS:");
 Serial.println(PumpF);
 delay(100);
 
  if( MoistureF > setMoistureF  || PumpF == 0)  //set conditions to set the pump low
  {
    Serial.println("Pump LOW");
    digitalWrite(Pump, LOW);
    }
   if( MoistureF < setMoistureF  || PumpF == 1)   //set conditions to set the pump HIGH
  {
...
//  else
//  {
//    Serial.println("Default Lights LOW");
//    digitalWrite(Light, LOW);
//    
//  }
